...
async def enter_text_and_click(
    ...
    print(f'enter_text_result:{result}')
    print("*************************************************")
     # Wait for a specified amount of time before clicking
    await asyncio.sleep(wait_before_click_execution)
    ...
    await browser_manager.take_screenshots(f"{function_name}_end", page)
    print(f'click_result:{result["detailed_message"]}')
    print("*************************************************")
