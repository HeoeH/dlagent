...
5. [VERY IMPORTANT]: If you are very confident that all the necessary information is already present in the current screenshot and webpage information,Please return only the task with action type "stop", do not return three tasks, and set is_complete to True.
