...
from agentq.core.models.models import FailFilterInput, FailFilterOutput
from agentq.core.prompts.prompts import LLM_PROMPTS


class FailFilter(BaseAgent):
    def __init__(self):
        self.name = "filter"
        self.ltm = None
        ...
        super().__init__(
            ...
            input_format=FailFilterInput,
            output_format=FailFilterOutput,
    ...
    def __modify_system_prompt(self, ltm):
        system_prompt: str = LLM_PROMPTS["FAIL_CRITIC_PROMPT"]
